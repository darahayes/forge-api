...
// request({method: 'POST', url: 'http://localhost:3000/api/login', json: true, body: {email: 'dara@example.com', password: 'password'}}, function(err,response,body) {
//   console.log(err);
//   auth_token = response.headers['authorization'];
//   console.log(auth_token)
//   // console.log(response);
...
//   // request({method: 'POST', url:'http://localhost:3000/api/calendar', json: true, body: body, headers: {'authorization': auth_token}}, function(err,response,body){ 
//   //     console.log(response.headers['content-type']);
//   //     console.log(err)
//   //     console.log(body)
//   // });
